<div align="center">
  ...
  <p><strong>L'outil ultime pour les Maîtres du Jeu : Éditeur Markdown + VTT + IA Locale + HUB Mobile + Sync Bidirectionnelle</strong></p>
  ...
  <p>
    ...
    <a href="https://github.com/LordMadTrix/grimoire"><img src="https://img.shields.io/badge/GitHub-Code_Source-181717?style=for-the-badge&logo=github&logoColor=white" alt="GitHub" /></a>
  </p>
...
**Grimoire** est une application Desktop conçue par et pour les Maîtres du Jeu (TTRPG). Elle rassemble en une seule interface tout ce dont vous avez besoin pour gérer vos campagnes, de la préparation à l'exécution.

Oubliez la multiplication des onglets et des applications : Grimoire combine un gestionnaire de notes Obsidian-like, une table virtuelle (VTT) hautement performante, et l'intelligence artificielle locale pour une expérience de jeu immersive et sans interruption.
...
- **Éclairage Dynamique & Atmosphères en Temps Réel** : Ambiance Jour ☀️ / Crépuscule 🌅 / Nuit 🌙 / Ténèbres 🌑 / Brume 🌫️ avec filtres d'ambiance colorimétriques, projections d'ombres dynamiques.
...
- **Analyseur Multi-Colonnes & Désentrelacement Spatial** : Reconstitution automatique de l'ordre de lecture logique sur les livres en 1, 2 ou 3 colonnes (type AD&D, Dragonlance, D&D 5e, Pathfinder).
...
- **Cartes Narratives Découpées (Onglet Chapitres)** : Découpe intelligente de la page en cartes de scènes (Descriptions 🌲, Dialogues 💬, Combats ⚔️, Évènements 📜) avec temps de lecture estimés.
...
### 4. 📱 Synchronisation Bidirectionnelle PC ↔ Mobile
- **Sync en Temps Réel** : Les modifications sur PC se reflètent instantanément sur mobile et vice-versa via WebSocket.
- **Vérification d'Intégrité** : Hash SHA256/MD5 de tous les fichiers pour détecter les corruptions.
- **Gestion des Conflits Intelligente** : Stratégies de résolution automatiques (LatestWins, PCWins, MobileWins, Manual).
- **Queue Fiable avec Retry** : Retry automatique jusqu'à 3 fois en cas d'erreur réseau.
- **Offline-Ready** : Les événements sont en queue locale en cas de déconnexion.
- **Monitoring en Temps Réel** : Tableau de bord avec stats de sync, événements en attente et conflits.
- **Documentation Complète** : Voir [SYNC_GUIDE.md](docs/SYNC_GUIDE.md) et [SYNC_API_REFERENCE.md](docs/SYNC_API_REFERENCE.md)

### 5. 👥 Multi-Écrans & HUB Mobile Joueur PWA
- **Vue Joueur Dédiée (Player View)** : Affichage sur 2ème écran / TV / Vidéoprojecteur sans aucune interface MJ, avec synchronisation du brouillard de guerre, de l'éclairage et mode Écran noir.
...
### 6. 🧙‍♂️ Outils du Maître du Jeu & Générateurs
...
### 7. 🎵 Mixeur Sonore & Studio Soundscape
...
### 8. 🌌 Bibliothèque Céleste & Audio Grimoire (Addon Store)
- **Catalogue Audio Studio Complet (+800 Pistes)** : Musiques orchestrales et bruitages d'ambiance classés par thèmes (⚔️ Combat, 🏰 Donjons & Horreur, 🍺 Villes & Tavernes, 🌲 Nature, etc.).
...
La synchronisation bidirectionnelle permet une synchronisation fluide et fiable des fichiers entre votre PC et votre appareil mobile.

**Caractéristiques:**
- ✅ Sync PC → Mobile & Mobile → PC en temps réel
- ✅ Vérification d'intégrité SHA256/MD5
- ✅ Résolution intelligente des conflits
- ✅ Queue fiable avec retry automatique
- ✅ Communication WebSocket en temps réel
- ✅ Offline-ready avec queue locale

### Documentation Complète

Consultez la documentation dédiée pour les détails d'implémentation et l'utilisation:

- **[📚 SYNC_GUIDE.md](docs/SYNC_GUIDE.md)** - Guide d'utilisation complet avec exemples
- **[🔌 SYNC_API_REFERENCE.md](docs/SYNC_API_REFERENCE.md)** - Référence API détaillée
...
// Créer le handler
let mut handler = SyncHandler::new(config, ws_bridge);
...
- **🏰 Bibliothèque Massive de Tampons (Stamps)** :
  - Des milliers d'assets HD : Nature (Arbres, Montagnes), Bâtiments (Châteaux, Villes, Villages), Donjons (Murs, Mobilier, Trésors), Maritime (Bateaux, Monstres marins), Cartographie (Boussoles, Légendes).
...
3. **Au premier lancement sous Windows** : Si l'avertissement *SmartScreen* apparaît (*« Windows a protégé votre ordinateur »*), cliquez sur **« Informations complémentaires »** puis **« Exécuter quand même »**. C'est normal pour les applications indépendantes nouvelles.
...
## 💖 Soutenir le Projet
Grimoire est un projet indépendant et gratuit développé avec passion pour les Maîtres du Jeu. Si vous appréciez l'application et souhaitez encourager son développement continu (nouvelles fonctionnalités, corrections de bugs, support multi-plateformes), merci de considérer une contribution 🙏
...
- **Synchronisation** : Module Rust dédié avec hachage, queue fiable et résolution de conflits.
